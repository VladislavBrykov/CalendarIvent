function db_login(username, password, email) {
    ...
    return new Promise((resolve, reject) => {
        ...
        const db_users = "CREATE TABLE IF NOT EXISTS holidays (id int(10) unsigned NOT NULL AUTO_INCREMENT, login varchar(50) NOT NULL, headding varchar(100) NOT NULL, body varchar(1000) NOT NULL, date varchar(100) NOT NULL, PRIMARY KEY (id));"
        connection.query(db_users, function(err, results) {
            if(err) console.log(err);
            else {
            ...
            // if(results) {
            //     console.log(results + "база данных праздники  +++++++++++++++++++++++++++++");
            //     const values = "INSERT INTO holidays VALUES ('holidays', 'new year', '2021', '31.08.20');"
            //     connection.query(values, function(err, results) {
            //         if(err) console.log(err + "-----------------");
            //         console.log(results + "база данных праздники +++++++++++++++");
            //     });
            // }           
